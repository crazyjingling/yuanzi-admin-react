...
export default {
	...
	async resolve (root, params, options) {
		...
		return Q()
			.then(() => {
				WorkModel.update({owner: params.data._id}, {'$set': { 'isDel': params.data.isDel}},{ "multi": true })
				ArticleModel.update({owner: params.data._id}, {'$set': { 'isDel': params.data.isDel}},{ "multi": true });
				CommentModel.update({commentUser: params.data._id}, {'$set': { 'isPassed': !params.data.isDel}},{ "multi": true });
