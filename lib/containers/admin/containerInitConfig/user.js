...
const userConfig = {
	...
	showFields: [
		{key: '_id', name: '编号', type: 'text'},
		{key: 'account.platform', name: '平台', type: 'label'},
		{key: 'account.username', name: '用户名', type: 'text'},
		{key: 'nickname', name: '昵称', type: 'text'},
		{key: 'avatar.ossUrl', name: '头像', type: 'image.circle'},
		{key: 'gender', name: '性别', type: 'gender'},
		...
		},
		{
			...
			options: [
				...
				{value: 'editLabels', name: '标签 ', action: 'onEditLabels'}
			]
		}
	],
	searchFields: [
