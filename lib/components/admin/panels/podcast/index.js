...
export default class Podcast extends Component {
	...
	onIntroductionChange(value){
		this.props.onChange('ownerIntroduction', value);
	}
	...
	renderowner() {
		if(this.state.isNextShow){
			return (
				<div>
					<div className="form-group">
						<label className="col-lg-2 control-label" htmlFor='owner'>讲师</label>
					...
					<div className="form-group">
						<label className="col-lg-2 control-label" htmlFor='ownerIntroduction'>微课详情</label>
						<div className="col-lg-10" >
							<ReactQuill ref='ownerIntroduction' style={{ border: '1px solid #e5e6e7'}}
							theme="snow"
							value={this.props.podcast.ownerIntroduction}
