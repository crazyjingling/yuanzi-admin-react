export default {
	...
	changeUserEntryValue: 'CHANGE_USERENTRY_VALUE',
	changeUserEntryToDefault: 'CHANGE_USERENTRY_TO_DEFAULT',
	// Strategy
	changeStrategyToDefault: 'CHANGE_STRATEGY_TO_DEFAULT',
	removeStrategy: 'REMOVE_STRATEGY',
	addStrategy: 'ADD_STRATEGY',
	updateStrategy: 'UPDATE_STRATEGY',
	recommendStrategy: 'RECOMMEND_STRATEGY',
	changeStrategyValue: 'CHANGE_STRATEGY_VALUE',
	// Activity
	removeActivity: 'REMOVE_ACTIVITY',
	addActivity: 'ADD_ACTIVITY',
	updateActivity: 'UPDATE_ACTIVITY',
	recommendActivity: 'RECOMMEND_ACTIVITY',
	changeActivityValue: 'CHANGE_ACTIVITY_VALUE',
	// Podcast
	removePodcast: 'REMOVE_PODCAST',
	addPodcast: 'ADD_PODCAST',
	updatePodcast: 'UPDATE_PODCAST',
	recommendPodcast: 'RECOMMEND_PODCAST',
	changePodcastValue: 'CHANGE_PODCAST_VALUE',
	//Order
	removeOrder: 'REMOVE_ORDER',
	addOrder: 'ADD_ORDER',
	updateOrder: 'UPDATE_ORDER',
	recommendOrder: 'RECOMMEND_ORDER',
	changeOrderValue: 'CHANGE_ORDER_VALUE',
	//Work
	removeWork: 'REMOVE_WORK',
	addWork: 'ADD_WORK',
	updateWork: 'UPDATE_WORK',
	changeWorkValue: 'CHANGE_WORK_VALUE',
	//Circle
	removeCircle: 'REMOVE_CIRCLE',
	addCircle: 'ADD_CIRCLE',
	updateCircle: 'UPDATE_CIRCLE',
	changeCircleValue: 'CHANGE_CIRCLE_VALUE',
	//Article
	removeArticle: 'REMOVE_ARTICLE',
	addArticle: 'ADD_ARTICLE',
	updateArticle: 'UPDATE_ARTICLE',
	changeArticleValue: 'CHANGE_ARTICLE_VALUE',
	// Material
	removeMaterial: 'REMOVE_MATERIAL',
	addMaterial: 'ADD_MATERIAL',
	recommendMaterial: 'RECOMMEND_MATERIAL',
	changeMaterialValue: 'CHANGE_MATERIAL_VALUE',
	// Topic
	changeTopicToDefault: 'CHANGE_TOPIC_TO_DEFAULT',
	updateTopic: 'UPDATE_TOPIC',
	removeTopic: 'REMOVE_TOPIC',
	addTopic: 'ADD_TOPIC',
	recommendTopic: 'RECOMMEND_TOPIC',
	changeTopicValue: 'CHANGE_TOPIC_VALUE',
	// Label
	getLabel: 'GET_LABEL',
	removeLabel: 'REMOVE_LABEL',
	addLabel: 'ADD_LABEL',
	updateLabel: 'UPDATE_LABEL',
	changeLabelFields:'CHANGE_LABEL_FIELDS',
	changeLabelToDefault:'CHANGE_LABEL_TO_DEFAULT',
	// Comment
	removeComment: 'REMOVE_COMMENT',
	changeCommentValue: 'CHANGE_COMMENT_VALUE',
